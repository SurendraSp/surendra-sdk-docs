...
|-----|---------|-------------|
| [Smart Ads](smart-ads/getting-started.md) | `1.0.2` | FAN + house-ad cross-sell banner, interstitial, and in-feed ads with Firebase Remote Config |
...
```
com.github.SurendraSp:smart-ads:1.0.2
```
